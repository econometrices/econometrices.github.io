...
Die Autoren halten zunächst fest, dass die zwei Arten von Diskriminierung (Frauen werden einerseits zuerst benachteiligt, andererseits später dann bevorzugt) nur erklärbar ist mit sogenannter statistischer Diskriminierung. Als statistische Diskriminierung bezeichnet man Diskriminierung, die auftritt, wenn ein Bewerter nur unvollständige Informationen hat, um die Fähigkeiten von jemandem zu beurteilen und daher aus Merkmalen wie Geschlecht oder Alter auf diese zu schliessen sucht.
